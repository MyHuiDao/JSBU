...
public class AssetBundle_danao : MonoBehaviour
{
    bool isDone;
    public static AssetBundle_danao instanced = null;
    public int changci;
...
//#endif
    ...
    void Awake()
    {
        down_load = PlayerPrefs.GetInt("danao");
    ...
    void ShowProgress()
    {
        if (!http3.isDone)
        {
            ...
            transform.GetChild(3).GetChild(0).GetComponent<Image>().fillAmount = 1 - http3.progress;
            float progress = 1 - transform.GetChild(3).GetChild(0).GetComponent<Image>().fillAmount;
        ...
        else
        {
            ...
            text3.text = "100%";
            down_load = 1;
            PlayerPrefs.SetInt("danao", down_load);
            transform.GetChild(3).GetChild(0).GetComponent<Image>().fillAmount = 0;
            transform.GetChild(3).GetComponent<CanvasGroup>().alpha = 0;

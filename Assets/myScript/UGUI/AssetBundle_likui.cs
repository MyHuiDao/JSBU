...
public class AssetBundle_likui : MonoBehaviour
{
    bool isDone;
    public static AssetBundle_likui instanced = null;
    public int changci;
...
//#endif
    ...
    void Awake()
    {
        down_load = PlayerPrefs.GetInt("likui");
    ...
    void ShowProgress()
    {
        if (!http3.isDone)
        {
            ...
            transform.GetChild(5).GetComponent<CanvasGroup>().alpha = 1;
            transform.GetChild(5).GetChild(0).GetComponent<Image>().fillAmount = 1 - http3.progress;
            float progress = 1 - transform.GetChild(5).GetChild(0).GetComponent<Image>().fillAmount;
        ...
        else
        {
            ...
            text3.text = "100%";
            down_load = 1;
            PlayerPrefs.SetInt("likui", down_load);
            transform.GetChild(5).GetChild(0).GetComponent<Image>().fillAmount = 0;
            transform.GetChild(5).GetComponent<CanvasGroup>().alpha = 0;

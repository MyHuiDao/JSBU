...
public class netConnect : MonoBehaviour
{
   ...
   public void Ani(int code)
    {
        GameObject.Find("Notices").GetComponent<Animation>().Play("webtishi");
        GameObject.Find("Notices").transform.GetChild(0).GetComponent<Text>().text = httpConnect.net[code].show;
    }
